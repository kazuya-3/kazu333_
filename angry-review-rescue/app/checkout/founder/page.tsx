...
//   e.g. export default function Page() { redirect("https://buy.stripe.com/..."); }

export default function FounderCheckoutPlaceholder() {
  return (
    <main className="container flex min-h-screen flex-col items-center justify-center py-20 text-center">
      <div className="rounded-2xl border border-bg-border bg-bg-card/70 p-8 max-w-lg">
        ...
        <p className="mt-3 text-sm text-ink-soft">
          This is where the <span className="text-ember-300">Founder Lifetime ($19)</span>{" "}
